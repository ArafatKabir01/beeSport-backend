...
const { transformErrorsToMap, getSlugify, generateRandomId, generateSalt, generatePassword } = require("../../utils");
...
const validateSingleUser = [param("userId").notEmpty().withMessage("User ID is required!")];
